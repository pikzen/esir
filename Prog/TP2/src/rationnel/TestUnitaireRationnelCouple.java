...
public class TestUnitaireRationnelCouple {
	...
	public void test_Constructeur3() {
		System.out.print("\nconstructeur de copie : vérifier égalité original/copie : ");    Rationnel r1 = new RationnelCouple(-21, -7);
	...
	public void inserer_tete_tableau_1elt() {
		...
		TRationnel.insererRationnel(new RationnelCouple(1, 3), lesRationnels, 1);
	...
	public void inserer_fin_tableau_1elt() {
		...
		TRationnel.insererRationnel(new RationnelCouple(1, 2), lesRationnels, 1);
		tester_egalite(lesRationnels, resu, 2);
	...
	public void inserer_tete() {
		...
		for (int i = 0; i < numerateurs.length; ++i) {
			TRationnel.insererRationnel(new RationnelCouple(numerateurs[i], denominateurs[i]),
							 lesRationnels, i);
		}
