...
public class TestUnitaireRationnelCouple {
	...
	public void inserer_tete_tableau_1elt() {
		...
		TRationnel
				.insererRationnel(new RationnelCouple(1, 3), lesRationnels, 1);
	...
	public void inserer_fin_tableau_1elt() {
		...
		TRationnel
				.insererRationnel(new RationnelCouple(1, 2), lesRationnels, 1);
		tester_egalite(lesRationnels, resu, 2);
		System.out.println("test réussi");
	}
	...
	public void inserer_tete() {
		...
		for (int i = 0; i < numerateurs.length; ++i) {
			resu[resu.length - i - 1] = new RationnelCouple(numerateurs[i],
					denominateurs[i]);
		}
		// insérer
		Rationnel[] lesRationnels = new Rationnel[numerateurs.length];
		for (int i = 0; i < numerateurs.length; ++i) {
			TRationnel.insererRationnel(new RationnelCouple(numerateurs[i],
